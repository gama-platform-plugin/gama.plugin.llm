...
import gama.plugin.types.ContentRetrieverType;
import gama.plugin.types.MCPClient;
import gama.plugin.types.MCPClientType;
import gama.plugin.types.MCPTransport;
import gama.plugin.types.MCPTransportType;
import gama.plugin.types.Memory;
